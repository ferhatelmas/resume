...
{\sl \textbf{Senior Software Engineer} \\ \href{https://getstream.io/}{Stream} Amsterdam, NL} \hfill November 19 - Now \\
\vspace{-0.3cm}
\begin{itemize}
  \item Improve the performance and the personalization of aggregated feeds by moving project from Python to Go and providing more customization options to rank / aggregate / manage the social graph.
  \item Maintain and modernize of \textit{feed} and \textit{chat} client libraries in JavaScript, Python, Go, etc.
  
\end{itemize}

{\sl \textbf{CTO} \\ \href{https://www.agflow.com}{AgFlow} Geneva, CH} \hfill January 18 - October 19 \\
\vspace{-0.3cm}
\begin{itemize}
