...
\section{EDUCATION}
	...
	Expected graduation: 03/2014, currently 5.12/6.00 GPA \\
...
\section{EXPERIENCE}
  ...
  \vspace{-0.3cm}
  \begin{itemize}
    \item Transition of legacy conference, meeting and workshop management web app from \textit{\href{http://www.zodb.org/}{ZODB}} to \textit{NoSQL}.
  \end{itemize}

  {\sl \textbf{\href{https://bitbucket.org/zurmo/}{Software Developer, Open Source}} \\ \href{http://zurmo.org}{Zurmo Open Source} Chicago, USA} \hfill Feb 13 - Present \\
  \vspace{-0.3cm}
  \begin{itemize}
